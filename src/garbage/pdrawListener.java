...
public interface pdrawListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code InatructionMoveAction}
	 * labeled alternative in {@link pdrawParser#instruction}.
	 * @param ctx the parse tree
	 */
	void enterInatructionMoveAction(pdrawParser.InatructionMoveActionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code InatructionMoveAction}
	 * labeled alternative in {@link pdrawParser#instruction}.
	 * @param ctx the parse tree
	 */
	void exitInatructionMoveAction(pdrawParser.InatructionMoveActionContext ctx);
	/**
