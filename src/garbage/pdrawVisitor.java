...
public interface pdrawVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code InatructionMoveAction}
	 * labeled alternative in {@link pdrawParser#instruction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInatructionMoveAction(pdrawParser.InatructionMoveActionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link pdrawParser#class}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass(pdrawParser.ClassContext ctx);
	/**
