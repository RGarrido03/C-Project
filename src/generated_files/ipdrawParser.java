...
public class ipdrawParser extends Parser {
	...
	public static final int
		...
		T__59=60, T__60=61, Type=62, INT=63, FLOAT=64, BOOL=65, Word=66, Name=67, 
		HexaColor=68, ESC=69, STRING=70, Comment=71, WS=72;
	public static final int
		...
		RULE_pause = 12, RULE_print = 13, RULE_variable = 14, RULE_incdec = 15, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"stdin", "pause", "print", "variable", "incdec", "expression", "tuple", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'/'", "'//'", "'*'", "'mod'", "'+'", "'-'", "'^'", "'\\u00BA'", "'deg'", 
			"'rad'", "'left'", "'right'", "'forward'", "'backward'", "'down'", "'up'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, "Type", "INT", "FLOAT", "BOOL", "Word", "Name", "HexaColor", 
	...
	public final MainContext main() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2146193010325748L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 79L) != 0)) {
				{
				{
				setState(48);
				statement();
	...
	@SuppressWarnings("CheckReturnValue")
	public static class InstructionWriteActionContext extends InstructionContext {
		public List<ExpressionContext> expression() {
			return getRuleContexts(ExpressionContext.class);
		}
		public ExpressionContext expression(int i) {
		...
		public InstructionWriteActionContext(InstructionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ipdrawListener ) ((ipdrawListener)listener).enterInstructionWriteAction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ipdrawListener ) ((ipdrawListener)listener).exitInstructionWriteAction(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			case T__53:
				...
				break;
			case T__30:
				_localctx = new InstructionWriteActionContext(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(199);
				match(T__30);
	...
	public static class IncdecContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ipdrawListener ) ((ipdrawListener)listener).enterIncdec(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ipdrawListener ) ((ipdrawListener)listener).exitIncdec(this);
		}
	}

	public final IncdecContext incdec() throws RecognitionException {
		IncdecContext _localctx = new IncdecContext(_ctx, getState());
		enterRule(_localctx, 30, RULE_incdec);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ExprIncDecContext extends ExpressionContext {
		public IncdecContext incdec() {
			return getRuleContext(IncdecContext.class,0);
		}
		public ExprIncDecContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ipdrawListener ) ((ipdrawListener)listener).enterExprIncDec(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ipdrawListener ) ((ipdrawListener)listener).exitExprIncDec(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				{
				_localctx = new ExprIncDecContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(252);
				incdec();
