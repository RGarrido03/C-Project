...
public class ElementsLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "Type", "INT", "FLOAT", 
			"FRACTION", "BOOL", "Word", "Name", "HexaColor", "ESC", "String", "Comment", 
			"WS"
		};
	}
	...
	public ElementsLexer(CharStream input) {
		super(input);
