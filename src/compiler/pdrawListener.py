...
class pdrawListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by pdrawParser#elseif.
    def enterElseif(self, ctx:pdrawParser.ElseifContext):
        pass

    # Exit a parse tree produced by pdrawParser#elseif.
    def exitElseif(self, ctx:pdrawParser.ElseifContext):
        pass


    # Enter a parse tree produced by pdrawParser#else.
    def enterElse(self, ctx:pdrawParser.ElseContext):
        pass

    # Exit a parse tree produced by pdrawParser#else.
    def exitElse(self, ctx:pdrawParser.ElseContext):
        pass
    ...
    # Enter a parse tree produced by pdrawParser#move.
    def enterMove(self, ctx:pdrawParser.MoveContext):
        pass

    # Exit a parse tree produced by pdrawParser#move.
    def exitMove(self, ctx:pdrawParser.MoveContext):
        pass


    # Enter a parse tree produced by pdrawParser#rotate.
    def enterRotate(self, ctx:pdrawParser.RotateContext):
        pass

    # Exit a parse tree produced by pdrawParser#rotate.
    def exitRotate(self, ctx:pdrawParser.RotateContext):
        pass


    # Enter a parse tree produced by pdrawParser#InstructionMoveRotateAction.
    def enterInstructionMoveRotateAction(self, ctx:pdrawParser.InstructionMoveRotateActionContext):
        pass

    # Exit a parse tree produced by pdrawParser#InstructionMoveRotateAction.
    def exitInstructionMoveRotateAction(self, ctx:pdrawParser.InstructionMoveRotateActionContext):
        pass
    ...
    # Enter a parse tree produced by pdrawParser#AssignmentMultipleVars.
    def enterAssignmentMultipleVars(self, ctx:pdrawParser.AssignmentMultipleVarsContext):
        pass

    # Exit a parse tree produced by pdrawParser#AssignmentMultipleVars.
    def exitAssignmentMultipleVars(self, ctx:pdrawParser.AssignmentMultipleVarsContext):
        pass
    ...
    # Enter a parse tree produced by pdrawParser#BackgroundCanvas.
    def enterBackgroundCanvas(self, ctx:pdrawParser.BackgroundCanvasContext):
        pass

    # Exit a parse tree produced by pdrawParser#BackgroundCanvas.
    def exitBackgroundCanvas(self, ctx:pdrawParser.BackgroundCanvasContext):
        pass
    ...
    # Enter a parse tree produced by pdrawParser#ExprConditionEquals.
    def enterExprConditionEquals(self, ctx:pdrawParser.ExprConditionEqualsContext):
        pass

    # Exit a parse tree produced by pdrawParser#ExprConditionEquals.
    def exitExprConditionEquals(self, ctx:pdrawParser.ExprConditionEqualsContext):
        pass
    ...
    # Enter a parse tree produced by pdrawParser#ExprAddSubMultDivModPow.
    def enterExprAddSubMultDivModPow(self, ctx:pdrawParser.ExprAddSubMultDivModPowContext):
        pass

    # Exit a parse tree produced by pdrawParser#ExprAddSubMultDivModPow.
    def exitExprAddSubMultDivModPow(self, ctx:pdrawParser.ExprAddSubMultDivModPowContext):
        pass
    ...
    # Enter a parse tree produced by pdrawParser#ExprConditionAndOr.
    def enterExprConditionAndOr(self, ctx:pdrawParser.ExprConditionAndOrContext):
        pass

    # Exit a parse tree produced by pdrawParser#ExprConditionAndOr.
    def exitExprConditionAndOr(self, ctx:pdrawParser.ExprConditionAndOrContext):
        pass
    ...
    # Enter a parse tree produced by pdrawParser#ExprConditionOrderRelation.
    def enterExprConditionOrderRelation(self, ctx:pdrawParser.ExprConditionOrderRelationContext):
        pass

    # Exit a parse tree produced by pdrawParser#ExprConditionOrderRelation.
    def exitExprConditionOrderRelation(self, ctx:pdrawParser.ExprConditionOrderRelationContext):
        pass
